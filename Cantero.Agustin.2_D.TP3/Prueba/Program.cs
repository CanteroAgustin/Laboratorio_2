...
namespace Prueba
{
    public class Program
    {
        static void Main(string[] args)
        {
           ...
           Alumno.EEstadoCuenta.AlDia);
            gim += a8;
            Instructor i1 = new Instructor(1, "Juan", "Lopez", "0",
           ...
           EntidadesAbstractas.Persona.ENacionalidad.Argentino);
            ...
            try
            {
                ...
                Jornada.Leer();
                Console.WriteLine("Archivo de Jornada {0} recuperado", jornada);
            }
            catch (ArchivosException e)
            {
                Console.WriteLine(e.Message);
            ...
            /*
             * TODO borrar
             * testear la lectura de un xml
            
            try
            {
                Gimnasio gim2 = new Gimnasio();
                Gimnasio.Leer(gim2);
                Console.WriteLine("Archivo de Gimnasio recuperado");
            }
            catch (ArchivosException e)
            {
                Console.WriteLine(e.Message);
